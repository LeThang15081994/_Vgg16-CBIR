...
def search_img(img_path, index):
    ...
    with open(r"D:\WorkSpace\_thangle15894\_AIproject\_person\_Vgg16-CBIR\database\ceramic\vectors.pkl", "rb") as f:
        vectors = pickle.load(f)
    with open(r"D:\WorkSpace\_thangle15894\_AIproject\_person\_Vgg16-CBIR\database\ceramic\paths.pkl", "rb") as f:
        paths = pickle.load(f)
...
if __name__ == "__main__":
    vectors_data(r"D:/WorkSpace/_thangle15894/_AIproject/_person/_Vgg16-CBIR/code/demo_ceramic/images_ceramic")
